        ...
        registerAndVerify: async (token, password, code) => {
            ...
            const isMatchCode = await bcrypt.compare(
                code.toString(),
                record.code_hash
            );
        ...
        confirmNewPassword: async (email, newPassword, confirmPassword) => {
            ...
            await emailService.sendNotification(
                email,
                "Forgot password",
                `Your password has been changed successfully. Try logging it again ${loginPageURL}`
            );
        ...
        resendVerificationCode: async (email, purpose) => {
            ...
            return {
                message: `${purpose}: Verification code resent successfully`,
            };
            } catch (error) {
            throw error;
            }
